...
// 静态 API 文件
live2d_settings['staticAPIFile'] = 'assets/static-api-file.json';
live2d_settings['staticPath'] = 'https://cdn.jsdelivr.net/gh/mrliangtec/live2d_api/model'
...
function loadModel(modelId, modelTexturesId = 0) {
    ...
    loadlive2d('live2d', localAPI('get', modelId, modelTexturesId), (live2d_settings.showF12Status ? console.log() : null));
}
